...
<div class="w-full flex justify-center items-center">
    <div class="container rounded-md relative flex justify-start items-center h-72 overflow-hidden">
        <img class=" object-cover brightness-75" src="image/humans.jpg" alt="">
        <div class="pl-32 py-10 absolute flex flex-col justify-start items-start text-xl text-shadow-md capitalize">
            <p class="py-5 text-4xl text-white">Womens Collections</p>
            {{ Breadcrumbs::render('HumansCollection') }}
        </div>
    </div>
</div>
...
<section class="w-full flex justify-center">
    <div class="container grid grid-cols-5 p-6 gap-5">
        @foreach ($HumansCollect as $MP)
        <div class="container col-span-4 sm:col-span-2 xl:col-span-1 shadow-lg shadow-gray-300 rounded-lg overflow-hidden">
            <div class="overflow-hidden">
                <img class="w-full transition duration-200 transform hover:scale-110" src="image/products/women/{{ $MP->image }}" alt="">
            </div>
            <div class="m-5">
                ...
                <div class="flex flex-col justify-between my-4">
                    <a href="/humansCollection/{{ $MP->id }}" class="btn text-sm">
...
<div class="w-full flex justify-center">
    {{ $HumansCollect->links('../partials/my_pagination') }}
</div>
